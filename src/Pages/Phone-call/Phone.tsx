...
export const Phone = () => {
  ...
  const [name, setName] = useState<string>("Abdul Aleem");
  const [phoneNumber, setphoneNumber] = useState<string>("012-34567-89");
        ...
        <div className="col-span-3 flex flex-col gap-4 p-4 max-lg:col-span-12">
          ...
          <div className="w-full bg-white rounded flex justify-between items-center px-4 py-2 cursor-pointer">
            <div className="flex flex-col gap-1 w-full">
              <span className="text-[10px] text-blue-400">Caller Name</span>
              <input
                type="text"
          ...
          <div className="w-full bg-white rounded flex justify-between items-center px-4 py-2 cursor-pointer">
            <div className="flex flex-col gap-1 w-full">
              <span className="text-[10px] text-blue-400">Phone Number </span>
              <input
                type="text"
                className="outline-none w-full text-sm"
