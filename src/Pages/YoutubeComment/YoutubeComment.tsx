  ...
  return (
    <>
      <div className="grid grid-cols-4 gap-4 h-[100vh]">
        <div className="col-span-1 p-4 max-lg:col-span-4">
          <div className="flex flex-col gap-4">
            <div>
            <svg xmlns="http://www.w3.org/2000/svg" id="yt-ringo2-svg_yt17" width="93" height="20" viewBox="0 0 93 20" focusable="false" aria-hidden="true">
  <g>
  ...
  <g id="youtube-paths_yt17">
    ...
    <path d="M92.6517 11.4999C92.6517 8.51994 92.3517 6.30994 88.9217 6.30994C85.6917 6.30994 84.9717 8.45994 84.9717 11.6199V13.7899C84.9717 16.8699 85.6317 19.1099 88.8417 19.1099C91.3817 19.1099 92.6917 17.8399 92.5417 15.3799L90.2917 15.2599C90.2617 16.7799 89.9117 17.3999 88.9017 17.3999C87.6317 17.3999 87.5717 16.1899 87.5717 14.3899V13.5499H92.6517V11.4999ZM88.8617 7.96994C90.0817 7.96994 90.1717 9.11994 90.1717 11.0699V12.0799H87.5717V11.0699C87.5717 9.13994 87.6517 7.96994 88.8617 7.96994Z"></path>
            ...
            <h2 className="text-lg font-bold text-white">
              Edit YouTube Comment Mockup
            </h2>
            <p className="text-white">Click on a text to edit it.</p>
            ...
            <div className="flex flex-col gap-2">
              <button className="pic-btn flex items-center gap-2 w-full" onClick={handleImage}>
                <FaPlus />
                Upload Profile Picture
              </button>
              <input ref={imageRef} type="file" accept="*/image" className="hidden" onChange={changeImage} />
              {image && <button className="pic-btn-del flex items-center gap-2 w-full" onClick={() => setImage('')}>
                Remove Profile Picture
              </button>}
            </div>
            <div className="flex gap-2">
                <button className="w-1/2 text-white transition-all duration-300 rounded-lg font-semibold hover:bg-white hover:text-black" onClick={() => navigate('/')}>Cancel</button>
                <button className="pic-btn font-semibold w-1/2" onClick={handleScreenshot}>Download</button>
            </div>
          </div>
        </div>
        <div className={`col-span-3 max-lg:col-span-4 flex justify-center items-center ${
