...
import { SpotifyPhoneImage } from "./SpotifyPhoneImage";
import html2canvas from "html2canvas";

export const SpotifyPhone = () => {
   ...
   const handleProfileImage = () => {
    ...
    const handleScreenshot = async () => {
      ...
      if (element) {
        ...
        link.href = dataUrl;
        link.download = "spotify-phone.png";
        link.click();
      }
    };
    ...
    <>
      <div className="grid grid-cols-12">
        <div className="col-span-3 flex flex-col gap-4 p-4 max-lg:col-span-12">
          <h2 className="text-white font-bold text-lg">Edit Spotify Mockup</h2>
          <p className="text-white text-sm">Click on the numbers to edit it.</p>
